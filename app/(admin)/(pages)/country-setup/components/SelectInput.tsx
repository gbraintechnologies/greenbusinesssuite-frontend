        ...
        <div className="relative">
          ...
          <select
            ...
            className={clsx(
              ...
              "focus:ring-0 border border-slate-300 focus:border focus:border-black rounded-[6px] mb-1 mt-[7px] outline-none focus:outline-none w-full px-4 py-3 font-medium text-slate-900",
              extraClasses
            )}
          >
