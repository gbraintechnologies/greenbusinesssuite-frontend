...
function EditCurrency() {
    ...
    const { register, handleSubmit, setValue, formState: { errors }, watch, reset } = useForm<typeOfSchema>({
            ...
            <div className="w-full">
                <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)} style={{ display: "inline-flex", width: "100%" }}>
                    <div className="w-full text-primary-dark flex justify-between">
                        <div>
                            <h3 className="font-semibold text-xl">Edit Currency / Denomination</h3>
                            <p className="text-black-400 text-sm">Edit configured denomination of Currencies for the company</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div style={{ width: '30%' }}>
                            {watch('denominations')?.map((denomination, index) => (
                                <div key={index} className="combined-input-container flex items-center justify-between border-b mb-1 pb-1" style={{ width: '100%' }}>
                                    <span>
