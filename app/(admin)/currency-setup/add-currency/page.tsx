                    ...
                    <img
                      src={
                        Countrie(
                          countriesData?.find(
                            (country) =>
                              country.id === getValues("jurisdiction_id")
                          )?.jurisdiction_name ?? ""
                        )?.flags.png
                      }
                      alt={
              ...
              {denominations.map((denomination, index) => (
                ...
                >
                  ...
                  >
                    <FiEdit2
                      size={20}
                      onClick={() => handleEdit(denomination.currency_id)}
                    />{" "}
                    &nbsp;
                    <RiDeleteBin5Line
                      size={20}
